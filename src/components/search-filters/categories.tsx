...
function Categories({ data }: { data: any }) {
  ...
  return (
    <div className='relative w-full'>
      <CategoriesSiedbar open={isSidebarOpen} onOpenChange={setIsSidebarOpen} data={data} />
      {/* Invisible, used for  */}
      <div ref={measureRef} className='opacity-0 pointer-events-none flex' style={{ position: 'fixed', top: -9999, left: -9999 }}>
